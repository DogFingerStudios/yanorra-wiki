...
**Thalen of the Eastvoid** was a renowned traveler who claimed to have journeyed beyond the Eastvoid Ocean, returning with unusual artifacts, wildlife, and plants from a place he called **Aunqara**.

A group known as the **Aunqaran** is said to have accompanied Thalen back and settled in Velu and other areas of the known world. Today, the existence of Aunqara, and the origination of the Aunqaran, is widely disputed and considered by many to be a myth. The Aunqaran themselves are now a small, insular group, concentrated in Velu, and claim to maintain cultural ties to Aunqara.
...
=== Computing
Computing remains limited in both capability and reach, shaped heavily by the disruptions following The Drift and the ongoing scarcity of reliable power. Digital systems exist, but they are neither ubiquitous nor essential to daily life, and are often viewed as fragile conveniences rather than dependable infrastructure.

Most machines in common use are text-oriented systems designed for recordkeeping, communication, and basic calculation rather than visual display. Processing power is modest, storage is constrained, and interaction typically occurs through keyboards and monochrome or low-resolution displays, reinforcing a culture of efficiency and brevity in digital communication.

The Intalink reflects these constraints directly. It is a largely text-driven network, favoring message boards, indexed archives, and direct terminal access over visual or interactive media. While experiments with more graphical systems are underway, they remain slow, resource-heavy, and impractical for widespread use under current conditions.

More advanced graphical computing environments do exist, but access is limited almost entirely to universities, state research institutions, and select government systems. These platforms are treated as experimental or strategic tools and have not yet reached public or commercial circulation.

As a result, mechanical tools, analog radios, and paper documentation continue to dominate everyday workflows, with computing systems serving as supplements rather than replacements. Film photography is technically possible but uncommon, as the materials required to produce and preserve film are scarce and typically reserved for institutional, archival, or scientific purposes.
